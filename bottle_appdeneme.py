...
comment_form = '''<form action = "/static/index.html" method = "post">
	<fieldset>
	<legend>Comment Section:</legend>
	<legend>Comment:</legend>
	<textarea name="comment" rows="30" cols="30">Please be nice on your comments</textarea>
